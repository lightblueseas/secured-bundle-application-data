...
public class JdbcUrlBeanTest
{
	...
	public void testNewPostgresJdbcUrl()
	{
		...
		final JdbcUrlBean bean = JdbcUrlBean.builder()
	...
	public void testNewH2JdbcUrl()
	{
		...
		final JdbcUrlBean bean = JdbcUrlBean.builder()
		.protocol("jdbc:h2:")
		.database("file:~/bundlemanagement")
		.parameter("MODE=PostgreSQL")
		.parameter("DB_CLOSE_ON_EXIT=FALSE")
		.parameter("DB_CLOSE_DELAY=-1")
		.build();
